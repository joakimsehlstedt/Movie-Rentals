...
/**
 * Database wrapper, provides a database API for the framework but hides details 
 * of implementation.
 */
class CDatabase {
    ...
    public function __construct($options) {
        ...
        try {
            ...
            throw new PDOException('Could not connect to database, hiding '
            . 'connection details.'); // Hide connection details.
        }
